        ...
        <div className="container mb-3">
            <div className={`${div_name} sm:col-span-4`}>
                ...
                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 mt-2">
                    <input type="text" name={name} id={id} className={`${className} block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6`} placeholder={placeholder} value={value} onChange={onChange} onFocus={onChange} />
                </div>
