"use client";
import { FontAwesomeIcon, faEye, faEyeSlash } from "@/app/api/routes/route"
            ...
            <div className="container mb-3">
                <div className={`${div_name} sm:col-span-4`}>
                    ...
                    <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 mt-2 relative">
                        ...
                        <button className="absolute right-2 top-2 cursor-pointer" onClick={togglePasswordVisibility}>
